...
사용: python stage1_produce.py            # 전체 생산 후 병합
      python stage1_produce.py --merge-only
"""
...
from load_aws import BASE_FOLDER, prepare_evaluation_data
from fast_idw import evaluate_idw_fast, EXT_COLUMNS
