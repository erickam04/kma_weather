...
import analyze_bias_feedback_followup as followup
import bias_data
from analyze_bias_feedback_followup import (
    CLASS_ORDER,
...
class BiasFeedbackFollowupQuarterTests(unittest.TestCase):
    ...
    def test_quarter_bootstrap_passes_one_paired_weight_matrix_to_shared_helper(self):
        ...
        import analyze_bias_feedback_followup as module
        from bias_significance import bootstrap_bias_effects as real_bootstrap
    ...
    def test_stable_quarter_seed_is_identical_across_python_hash_seed_processes(self):
        ...
        command = [
            ...
            "-c",
            (
                "from analyze_bias_feedback_followup import _stable_quarter_seed; "
